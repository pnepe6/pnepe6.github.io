	...
	render() {
		...
		return (
			<div>
				...
				<SectionIntro>
					<p><strong>Grâce à ma formation en Alternance, j'ai eu la chance de participer à de nombreux projets.</strong></p>
					<p>Mes passions mon entraînées dans la gestion de projet évènementiel pour commencer, puis rapidement vers la gestion de projet web (eReputation, inbound marketing, stratégie SEO, etc...).</p>
				</SectionIntro>
				<Tabs>
					<div className="tab">
					  <button
